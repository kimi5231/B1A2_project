...
TESTPROJECT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
TESTPROJECT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_TestProject(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_TestProject(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_GitHub_B1A2_project_B1A2_project_unreal_TestProject_Source_TestProject_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_TestProject_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 1343670581U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 2257079243U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitHub_B1A2_project_B1A2_project_unreal_TestProject_Source_TestProject_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_TestProject_551927548(TEXT("/Script/TestProject"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_GitHub_B1A2_project_B1A2_project_unreal_TestProject_Source_TestProject_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_TestProject_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GitHub_B1A2_project_B1A2_project_unreal_TestProject_Source_TestProject_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_TestProject_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
